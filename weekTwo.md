...
FROM (SELECT *,
CASE WHEN a.pizza_id = 1 THEN 12 ELSE 10 END AS price
FROM customer_orders a INNER JOIN runner_orders b ON a.order_id=b.order_id
WHERE cancellation IS NULL) as tab
```
| total |
| --------- | 
| 114         | 
...
CREATE TABLE runner_ratings (
  ...
  "comment" VARCHAR(100),
  "rating_time" TIMESTAMP DEFAULT CURRENT TIMESTAMP
);
INSERT INTO runner_rating ("order_id", "runner_id", "rating", "comment")
VALUES
  (1, 1, 5, 'Excellent service!'),
  (2, 2, 4, 'Fast delivery, but a bit cold.'),
  (3, 3, 3, 'Average service.'),
  (4, 1, 5, 'Great job!'),
  (5, 2, 2, 'Late delivery and missing items.'),
  (6, 3, 4, 'Very polite and quick.'),
  (7, 1, 5, 'Delivered hot and fresh.'),
  (8, 2, 3, 'Decent service, could be faster.'),
  (9, 3, 5, 'Fantastic!'),
  (10, 1, 4, 'Good delivery overall.');

SELECT *
FROM runner_rating
```

| rating_id | order_id | runner_id | rating | comment                         | rating_time          |
|----------:|---------:|----------:|-------:|---------------------------------|---------------------:|
|         1 |        1 |         1 |      5 | Excellent service!              | 2023-08-01 10:06:44.747424  |
|         2 |        2 |         2 |      4 | Fast delivery, but a bit cold.  | 2023-08-01 10:06:44.747424  |
|         3 |        3 |         3 |      3 | Average service.                | 2023-08-01 10:06:44.747424   |
|         4 |        4 |         1 |      5 | Great job!                      | 2023-08-01 10:06:44.747424   |
|         5 |        5 |         2 |      2 | Late delivery and missing items.| 2023-08-01 10:06:44.747424  |
|         6 |        6 |         3 |      4 | Very polite and quick.          | 2023-08-01 10:06:44.747424  |
|         7 |        7 |         1 |      5 | Delivered hot and fresh.        | 2023-08-01 10:06:44.747424 |
|         8 |        8 |         2 |      3 | Decent service, could be faster.| 2023-08-01 10:06:44.747424  |
|         9 |        9 |         3 |      5 | Fantastic!                      | 2023-08-01 10:06:44.747424   |
|        10 |       10 |         1 |      4 | Good delivery overall.          | 2023-08-01 10:06:44.747424  |
